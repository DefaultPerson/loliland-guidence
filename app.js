...
(function () {
  ...
  var WAVES = {
    ...
    3: { name: "Фундамент: техника ∥ магия", sub: "Обе ветки с нуля до рабочего фундамента: первая инфузия, Мультитеплица, алтарь среднего тира. А — техника, Б — магия, В — снабжение." },
    4: { name: "Масштабирование", sub: "Всё на поток: боссы, ферма эссенции, золотые руны, бесконечные кровь и мана — готовность к нейтрониевому эндшпилю." },
    5: { name: "Фундамент эндгейма", sub: "Ключевые мультиблоки (Слияние, Инферналка, синтезатор), конвейер материи, Дракон Края, дисперсионные панели." },
    6: { name: "Промышленный эндшпиль", sub: "Масштаб панелей до кровавых тиров, души драконов, пчёлы-хаб, нейтроний и лестница звёзд до Зодиуса." },
    7: { name: "Финал", sub: "«Дорога к Бесконечному»: Катализатор -> Слиток -> Infinity-сет -> THE TRUE END." }
  };
  var TRACK = {
  ...
  var STAGE_ROLE = {
    ...
    stage4: "А: поток EU · Б: мана/кровь · В: фермы душ",
    stage5: "А: мультиблоки · Б: кровь/Ботания · В: пчёлы",
    stage6: "А: панели/звёзды · Б: души/тиры · В: пчёлы/спавнеры",
    stage7: "финал: все · В: каталики и кейсы"
  };
  ...
  var STAGE_ICON = {
    ...
    stage3: "icons/Thaumcraft_blockTable.png",
    stage4: "icons/Botania_blackLotus.png",
    stage5: "icons/lolidimensions_dragon_heart.png",
    stage6: "icons/Forestry_beeCombs.png",
    stage7: "icons/Avaritia_Crystal_Matrix.png"
  };
