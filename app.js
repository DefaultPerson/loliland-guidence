...
(function () {
  ...
  var WAVES = {
    ...
    2: { name: "Ранняя техника", sub: "Инструменты и базовая обработка — можно вести параллельно." },
    3: { name: "Развитие — параллельные ветки", sub: "Эти этапы проходятся одновременно. Вдвоём удобно делить: один ведёт технику (AE2, машины, энергия), другой — магию (Таумкрафт, Botania, кровь, пчёлы)." },
    4: { name: "Эндгейм-сборка", sub: "Сходятся ветки: энергия, драконы, реликвии — частично параллелятся." },
